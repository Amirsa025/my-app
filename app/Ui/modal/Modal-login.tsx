...
export default function ModalLogin() {
    ...
    return (
        <>
            <div className="">
                <button className="text-nav  font-normal  text-[14px] center " onClick={openModal}>login</button>
            </div>
                                ...
                                <Dialog.Panel
                                    ...
                                    >
                                        <div className="text-center md:text-left ">
                                            <span
                                                className="text lg:text-[70px] md:text-[50px] text-[24px] font-bold">Login</span>
                                        </div>
                                    </Dialog.Title>
                                    <Dialog.Panel   className="lg:px-[40px] px-[1rem] pt-[1rem]">
                                        <div className="">
                                            <p className="text-primery text-[12px] md:text-[14px]">for creating your project please login to your account</p>
                                        </div>
                                        <div className={"pt-[0.75rem] flex"}>
                                            <span className={"text-white text-[12px] md:text-[14px]"}>Don’t have an account? </span>
                                        {/*        Link to signup*/}
                                        </div>
