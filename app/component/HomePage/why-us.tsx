...
import {index} from "../../data/Home-page";
const WhyUs = () => {
    return (
        <section>
                                ...
                                return (
                                    <>
                                        <div  className="rounded-[32px] w-[150px] md:w-[224px] lg:w-[300px] xl:w-[350px] lg:h-[400px] h-[150px] md:h-[267px] px-4 mx-auto  bg-gl bg-why-section">
                                            <div  key={id} className = {'center lg:pt-[78px] md:pt-[40px] pt-[8px] '}>
                ...
                <div className={"container py-8 "}>
                    <div className="grid grid-cols-3 justify-between px-[60px] bg-why-section rounded-[35px]">
